...
#define STRING_CONFIG_H_AUTHOR "(CHARZ-GOA)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "charz"
...
#define X_MIN_ENDSTOP_INVERTING true // Set to true to invert th logic of the endstop.
 ...
 *
 * Note that if 
 *  is enabled, saved values will override these.
 */
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 550, 685 }
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 50, 50, 500, 100 }
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 100, 100, 2000, 1000 }
